...
In this workflow, as the workload of characteristic point extraction is relatively lightweight, it has been combined into the local clustering step. It is obvious that the job of both characteristic point extraction and local clustering are independent of each others, so it would be easily distributed by performing the job in the MAP.
